...
/**
 * Screen for the supplier pipe. Shows 3×3 supply-config slots and player inventory.
 * Each slot: place an item with the desired stack count to set the supply target.
 */
@Environment(EnvType.CLIENT)
public class SupplierPipeScreen extends AbstractContainerScreen<SupplierPipeMenu> {

    public SupplierPipeScreen(SupplierPipeMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderLabels(GuiGraphics graphics, int mouseX, int mouseY) {
        graphics.drawString(font, "Supplier Pipe", 7, 6, 0x404040, false);
