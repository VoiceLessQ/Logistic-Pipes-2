...
public class PipeFluidInsertion extends FluidRoutedPipe {
	...
	public void enabledUpdateEntity() {
		...
		for (Direction dir : Direction.values()) {
			...
			FluidStack toSend = transport.sideTanks[dir.ordinal()].drain(result.getValue2().getSinkAmountInt(), net.neoforged.neoforge.fluids.capability.IFluidHandler.FluidAction.EXECUTE);
